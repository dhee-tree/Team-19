                ...
                <div class="accordion" id="FilterAccordian">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="SortAccordion-heading">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#SortAccordion-collapse" aria-expanded="false"
                                aria-controls="SortAccordion-collapse">
                                Sort By
                            </button>
                        </h2>
                        <div id="SortAccordion-collapse" class="accordion-collapse collapse"
                            aria-labelledby="SortAccordion-heading">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="FilterAccordion-heading">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#FilterAccordion-collapse" aria-expanded="false"
                                aria-controls="FilterAccordion-collapse">
                                Filter By
                            </button>
                        </h2>
                        <div id="FilterAccordion-collapse" class="accordion-collapse collapse"
                            aria-labelledby="FilterAccordion-heading">
                            <div class="accordion-body">
                                <!-- Category -->
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="Kitchen"
                                                    name="categories[]" value="Kitchen" <?php if (in_array('Kitchen',
                                                    request('categories', []))) { echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="Dining"
                                                    name="categories[]" value="Dining" <?php if (in_array('Dining',
                                                    request('categories', []))) { echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="Bedroom"
                                                    name="categories[]" value="Bedroom" <?php if (in_array('Bedroom',
                                                    request('categories', []))) { echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="Bathroom"
                                                    name="categories[]" value="Bathroom" <?php if (in_array('Bathroom',
                                                    request('categories', []))) { echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="Office"
                                                    name="categories[]" value="Office" <?php if (in_array('Office',
                                                    request('categories', []))) { echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="Garden"
                                                    name="categories[]" value="Garden" <?php if (in_array('Garden',
                                                    request('categories', []))) { echo 'checked' ; } ?>>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="FilterAccordian-collapseRating" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="5" name="ratings[]"
                                                    value="5" <?php if (in_array('5', request('ratings', []))) {
                                                    echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="4" name="ratings[]"
                                                    value="4" <?php if (in_array('4', request('ratings', []))) {
                                                    echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="3" name="ratings[]"
                                                    value="3" <?php if (in_array('3', request('ratings', []))) {
                                                    echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="2" name="ratings[]"
                                                    value="2" <?php if (in_array('2', request('ratings', []))) {
                                                    echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="1" name="ratings[]"
                                                    value="1" <?php if (in_array('1', request('ratings', []))) {
                                                    echo 'checked' ; } ?>>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="0" name="ratings[]"
                                                    value="0" <?php if (in_array('0', request('ratings', []))) {
                                                    echo 'checked' ; } ?>>
