...
<body class="antialiased">
    ...
    @if (Auth()->user()->access_level == 2)
        <a type="button" href="{{ url('admin-panel/tickets') }}" class="nav-link position-relative" type="submit" data-mdb-ripple-init>
    ...
    @elseif (Auth()->user()->access_level == 3 || Auth()->user()->access_level == 4)
        <a type="button" href="{{ url('admin-panel') }}" class="nav-link position-relative" type="submit" data-mdb-ripple-init>
            <button class="ms-1 btn btn-outline-light rounded-pill position-relative z-index-1" type="submit" data-mdb-ripple-init>
                <i class="fa-solid fa-user"></i>
            </button>
            @if (Auth()->check() && !Auth()->user()->isVerified())
    ...
    @else
        <a type="button" href="{{ url('user-panel') }}" class="nav-link position-relative" type="submit" data-mdb-ripple-init>
            <button class="ms-1 btn btn-outline-light rounded-pill position-relative z-index-1" type="submit" data-mdb-ripple-init>
                <i class="fa-solid fa-user"></i>
            </button>
            @if (Auth()->check() && !Auth()->user()->isVerified())
