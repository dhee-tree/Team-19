...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = \App\Models\Product::factory()->count(30)->sequence(
            ['title' => 'Rivulet', 'description' => 'Embrace sustainable comfort with the Rivulet chair, crafted from recycled plastics. Its sleek design and ergonomic features make it an eco-conscious choice for modern living spaces.', 'images' => 'images/products/1/(1).png,images/products/1/(2).png,storage/images/products/1/(3).png'],
