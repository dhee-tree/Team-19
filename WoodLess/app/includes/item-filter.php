                    ...
                    <div id="FilterAccordian-collapseCategories" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <form id="categories" action="/form-endpoint" method="get">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="Couches">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="Wardrobes">
                                        <label class="form-check-label" for="Wardrobes">
                                            Wardrobes
                                        </label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="Cushions">
                                        <label class="form-check-label" for="Cushions">
                                            Cushions
                                        </label>
                                    </div>
                                </div>
